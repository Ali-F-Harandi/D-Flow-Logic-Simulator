...
/**
 * Configurable DIP Switch — 2 to 8 switches, default 8.
 * Renamed from DipSwitch8. Type string changed from 'DipSwitch8' to 'DipSwitch'.
 */
export class DipSwitch extends Component {
  ...
  constructor(id, switchCount = 8) {
    ...
    super(id, 'DipSwitch', 0, switchCount);
